"""Pydantic models for the HealthCore API.
Covers Supplier Directory, Authentication (Users/Profiles), and the
Centralized Incident Manager. Input and output schemas are kept separate:
server-managed fields (`id`, `updated_at`, `created_at`) are never accepted
from clients.
"""
