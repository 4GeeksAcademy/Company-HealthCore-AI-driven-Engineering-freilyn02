export default function About() {
    return (
      <div className="px-6 py-16 max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold text-blue-700 mb-6">Our story</h1>
        ...
        <p className="text-gray-700 mb-4">
          ...
          Atlantic: patients in mid-sized towns had to travel long distances or
          wait weeks for routine specialist care.
        </p>
  
        <p className="text-gray-700 mb-4">
          Starting with a single clinic in Bristol, UK, and a sister clinic in
          Tampa, Florida, HealthCore grew through a &quot;hub-and-spoke&quot;
          model — small, fully-staffed outpatient clinics connected by a shared
          digital backbone, rather than large centralized hospitals.
        </p>
